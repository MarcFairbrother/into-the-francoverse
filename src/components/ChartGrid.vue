<template>
  <g class="grid">
    ...
    <path class="grid__horizontal" data-count="2" d="M-5,120 L565, 120" />
    <path class="grid__horizontal" data-count="3" d="M-5,110 L565, 110" />
    <path class="grid__horizontal" data-count="4" d="M-5,100 L565, 100" />
    <path class="grid__horizontal" data-count="5" d="M-5,90 L565, 90" />
    <path class="grid__horizontal" data-count="6" d="M-5,80 L565, 80" />
    <path class="grid__horizontal" data-count="7" d="M-5,70 L565, 70" />
    <path class="grid__horizontal" data-count="8" d="M-5,60 L565, 60" />
    <path class="grid__horizontal" data-count="9" d="M-5,50 L565, 50" />
    <path class="grid__horizontal" data-count="10" d="M-5,40 L565, 40" />
    <path class="grid__horizontal" data-count="11" d="M-5,30 L565, 30" />
    <path class="grid__horizontal" data-count="12" d="M-5,20 L565, 20" />
    <path class="grid__horizontal" data-count="13" d="M-5,10 L565, 10" />
    <path
      v-for="(year, i, n) in allYears"
      :key="i"
      :data-year="i"
      class="grid__vertical"
      :d="`M${n * 10},145 L${n * 10}, 5`"
    />
    <text
      v-for="(year, i, n) in allYears"
      :key="n"
      ...
      y="172"
      :x="n * 10 - 2"
      fill="rgba(10, 10, 10, .75)"
      class="year__label"
      style="font-size: 5px;"
      :transform="`rotate(-55, ${n * 10 - 15}, 165)`"
    >
      {{ i }}
    </text>
  </g>
